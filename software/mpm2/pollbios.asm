...
; TH - try to make it faster with direct call instead of table lookup
...
not1second: ld a, (ticking) ; test if system tick should be running
            ...
            call xdos
timerdone:
			jp uart1done ; TH: For polling bios jump over uart tests
...
sysvectors:
initmsg:    db 13, 10, "Z80 MP/M-II polling XIOS (Will Sowerbutts, [TH 20151213])", 0 ; MP/M print a CRLF for us
